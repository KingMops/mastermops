...
from .models import Videogame, Toy, Gamepad, Console, Category, LatestProducts, Customer, Cart, CartProduct
...
class BaseView(CartMixin, View):
    def get(self,request,*args,**kwargs):
        ...
        products = LatestProducts.objects.get_products_for_main_page('toy','gamepad','videogame','console')
        context = {
